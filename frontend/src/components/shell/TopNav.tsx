...
const TABS = [
  { label: "Simulate", href: "/app/simulate", active: true },
  { label: "Customers", href: "/app/customers", soon: true },
  { label: "Vendors", href: "/app/vendors", soon: true },
  { label: "Intelligence", href: "/app/intelligence", soon: true },
  { label: "Reports", href: "/app/reports", soon: true },
];
